...
print("{}, is the MAE".format(rf_val_mae), "for Random Forest.")
print()
print("Interesting! The Decision Tree model appears to have a lower MAE than the Random Forest.\
 The DT model must be relatively stable, though there really is little difference between the two.")
